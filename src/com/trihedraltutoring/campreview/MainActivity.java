package com.trihedraltutoring.campreview;
import java.io.File;
...
public class MainActivity extends Activity {
	...
	public void recordClicked(View v) {
    	...
    	if (isRecording){
	    	...
	    	((Button)findViewById(R.id.button_camera)).setVisibility(0); // enable cam switch
	    	((Button)findViewById(R.id.button_view)).setVisibility(0); // enable view
	    	...
	    	((Button)findViewById(R.id.button_camera)).setVisibility(4); // disable cam switch
	    	((Button)findViewById(R.id.button_view)).setVisibility(4); // disable view
    ...
    public void focusClicked(View v) {
    	((Button)v).setVisibility(4); // disable button
	...
	public boolean onTouchEvent(MotionEvent e) {
		...
		((Button)findViewById(R.id.button_focus)).setVisibility(0); // show auto focus button
